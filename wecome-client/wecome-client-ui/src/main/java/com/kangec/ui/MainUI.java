package com.kangec.ui;

import com.kangec.common.CacheUtil;
import com.kangec.common.UIBinding;
import com.kangec.contract.MainContract;
import com.kangec.presenter.MainPresenter;
import com.kangec.ui.chats.*;
import com.kangec.ui.contact.*;
...
/*        groupListView = binding("groupListView", ListView.class);
    ...
    /**
     * 在页面初始化的时候，将群组{@link com.kangec.ui.contact.ContactGroupItem} 添加至
     * 群组列表{@link com.kangec.ui.contact.ContactGroupList}内,并绑定事件处理。
     * @param groupId   群组ID
    ...
    /**
     * 在页面初始化的时候，将联系人信息附着在{@link com.kangec.ui.contact.ContactItem}中，
     * 并将其显示在{@link com.kangec.ui.contact.ContactList}内
     *
