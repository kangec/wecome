...
/**
 * 联系人视图组件，它将填充至{@link ContactList}
 */
public class ContactItem {
    ...
    public ContactItem(String userId, String userNickName, String userHead){
        // 用户底板(存储用户ID)
        pane = new Pane();
        pane.setId(userId);
        ...
        headLabel.setStyle(String.format("-fx-background-image: url('/icon/avatar/%s.jpg')", userHead));
