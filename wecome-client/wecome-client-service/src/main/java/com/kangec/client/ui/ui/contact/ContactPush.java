...
/**
 * 用户点击 {@link OperationContact}后显示的子页面
 *
 * 联系人推荐和搜索添加
 */
public class ContactPush {
     ...
     */
    public ContactPush(String userId, String userNickName, String userHead, Integer status) {
        pane = new Pane();
        ...
        headLabel.setStyle(String.format("-fx-background-image: url('/icon/avatar/%s.png')", userHead));
